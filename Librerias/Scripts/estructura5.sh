...
elif [ "$nombre_usuario" = "Enrique" ] || [ "$nombre_usuario" = "enrique" ]; then echo "Te la meto detrás del tabique"

elif [ "$nombre_usuario" = "Mario" ] || [ "$nombre_usuario" = "mario" ]; then echo "Me comes los huevos detras del campanario"
